...
{% assign category2 = "HackThebox" %}
  <div class="archive-group">
    ...
    {% capture category_name2 %}{{ category2 }}{% endcapture %}
    ...
    {% for post in site.categories[category_name] %} <!---  Individual Posts--->
      <article class="post-preview">
        ...
        <li><h4 style="margin-left: 0px"><a href="google.com">{{post.thumbnail-img}}, {{category}}, {{category2}}, {{category_name2}} {{site.categories}}</a></h4></li> <!---  Debug Output --->
